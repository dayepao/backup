...
const upstream_path = '/lFgW4Z0ytq'
...
async function fetchAndApply(request) {
    ...
    if (blocked_region.includes(region)) {
        ...
        new_response_headers.set('Access-Control-Allow-Methods', '*');
        new_response_headers.set('Access-Control-Allow-Credentials', 'true');
        new_response_headers.set('Access-Control-Allow-Headers', 'Content-Type,Access-Token');
